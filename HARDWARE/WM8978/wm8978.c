...
u8 WM8978_Init(void)
{
  ...
  GPIO_Init(GPIOA, &GPIO_InitStructure);//初始化
	...
	//PC12/PC10/PC11/PC7复用功能输出
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_12 | GPIO_Pin_11|GPIO_Pin_10|GPIO_Pin_7;
  GPIO_InitStructure.GPIO_Mode = GPIO_Mode_AF;//复用功能
  GPIO_InitStructure.GPIO_OType = GPIO_OType_PP;//推挽 
  GPIO_InitStructure.GPIO_Speed = GPIO_Speed_100MHz;//100MHz
  GPIO_InitStructure.GPIO_PuPd = GPIO_PuPd_UP;//上拉
  GPIO_Init(GPIOC, &GPIO_InitStructure);//初始化
	...
	GPIO_PinAFConfig(GPIOC,GPIO_PinSource11,GPIO_AF5_SPI3);	//PC11 ,AF6  I2S_ADCDATA I2s_SDOUT I2S3_SD是AF6!!!
	GPIO_PinAFConfig(GPIOC,GPIO_PinSource7,GPIO_AF_SPI3);	//PC7 ,AF6  I2S_MCK
	GPIO_PinAFConfig(GPIOC,GPIO_PinSource12,GPIO_AF_SPI3);	//PC12 ,AF6  I2S_DACDATA  I2s_SDIN
